...
public final class ItemAppBinding implements ViewBinding {
  ...
  private ItemAppBinding(@NonNull LinearLayout rootView, @NonNull CheckBox checkBox,
  ...
  public static ItemAppBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemAppBinding((LinearLayout) rootView, checkBox, ivAppIcon, tvAppName,
          tvPackageName);
    }
